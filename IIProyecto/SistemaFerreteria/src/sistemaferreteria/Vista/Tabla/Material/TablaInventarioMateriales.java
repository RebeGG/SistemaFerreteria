package sistemaferreteria.Vista.Tabla.Material;
...
public class TablaInventarioMateriales extends JTable {
    public TablaInventarioMateriales(TableModel modeloDatos, TableColumnModel modeloColumnas) {
    ...
    public void actualizar() {
        ((ModeloTablaInventarioM) getModel()).actualizar();
    }
}
